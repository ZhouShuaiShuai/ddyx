...
public class UserNameUtil {
    ...
    private static String[] names ={
            ...
            "戚件","家好","Ql","蒙邪","鄂凤","齐问","种红色","戴a","南尤","管W","季号","关纠","裘古代","安奶奶","阮电","沈万","褚年代",
            ...
            "游c","许匆","伏妈","经凶","阎轨","师g","g三","楚抹布","饶发","包阶","毛舌","洪幼","臧议","皮手术","越臣","龚百","宋手术","安手",
            ...
            "周后果","s毛","魏们","苌w","山动","伊寸","扈园丁","白斗","e沙子","全胖子","封中午","宓认识"
    };
